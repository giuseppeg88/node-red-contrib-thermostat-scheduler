...
## Known Bugs
**(!!!) There is a UI bug in the node-red-dashboard 2.27.0 (Home Assistant Addon v8.0.1): [UI dropdown - Unable to set a preselected option](https://github.com/node-red/node-red/issues/2852)**
